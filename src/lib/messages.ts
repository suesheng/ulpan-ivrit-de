...
export const messages: Record<UiLocale, Messages> = {
  de: {
    ...
    soGehts: {
      ...
      formLead: "Die Nachricht geht an uns per E-Mail. Das ersetzt nicht den Mitgliedsantrag.",
  ...
  ru: {
    ...
    soGehts: {
      ...
      formLead: "Сообщение уйдёт нам на почту. Это не замена заявки в союз.",
  ...
  en: {
    ...
    soGehts: {
      ...
      formLead: "The message is sent to us by email. It does not replace the membership application.",
